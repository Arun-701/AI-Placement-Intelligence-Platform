...
class TopicResult(BaseModel):
    subject: str
    domain: str = Field(default="Auto-Discovered", description="Predicted domain of the topic")
    topic: str
    ...
    subtopics: List[str] = []
    source: str = Field(default="ml", description="Classification source: ml, gemini, or ml_fallback")
