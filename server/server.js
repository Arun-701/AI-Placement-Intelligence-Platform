...
const roadmapCatalogRoutes = require("./routes/roadmapCatalogRoutes");
...
app.use("/api/ai/mentor", aiLimiter, aiMentorRoutes);
console.log("[INIT] Registered aiMentorRoutes (includes POST /analyze and GET /topics)");
...
console.log("[INIT] Registered adaptiveAssessmentRoutes at /api/adaptive-assessment");
app.use("/api", roadmapRoutes);
app.use("/api", roadmapCatalogRoutes);
