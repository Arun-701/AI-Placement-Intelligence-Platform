...
export default function AdminReports() {
  ...
  return <>
    <div className="page-title"><div><h1>Placement Performance</h1><div className="subtitle">Student readiness and assessment leaderboard</div></div><button className="btn secondary" disabled={!filtered.length} onClick={exportCsv}>Export CSV</button></div>
