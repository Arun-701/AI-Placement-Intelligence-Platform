...
export default function AdminAssessments() {
  ...
  const filtered = items.filter((item) => tab === 'VIEW_ALL' || (tab === 'ASSIGNED' ? item.statusLabel !== 'NOT_ASSIGNED' : item.statusLabel === 'NOT_ASSIGNED'))
